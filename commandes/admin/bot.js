...
module.exports.run = async (client, message, args) => {
   ...
   owner = await client.users.fetch(config.bot.owner)
    ...
    .addField(`🔹 Type d'abonnement:`, `[${config.login.type}](http://Orumaa.bot)`, true)
    .addField(`🔹 Durée de l'abonnement:`, `[${config.login.date}](http://Orumaa.bot)`, true)
    .addField(`🔹 Acheteur de l'abonnement:`, `[${owner.username}#${owner.discriminator}](http://Orumaa.bot) (\`${owner.id}\`)`, true)
